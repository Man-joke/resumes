  ...
  const main = () => {
    ...
    function mapcheck() {
      ...
      $('.region-map area').click( function(){
        idx = $(this).index();
        $('.mapImg').attr('src', '../../resources/images/layout/map_back_' + ( idx + 1 ) + '.png')
      })

      $('.region-map area').mouseover( function(){
        idx = $(this).index();
        $('.mapImg-over').attr('src', '../../resources/images/layout/map_img_' + ( idx + 1 ) + '.png')
      })
      $('.region-map area').mouseout( function(){
        idx = $(this).index();
        $('.mapImg-over').attr('src', '../../resources/images/layout/map_img.png')
      })
